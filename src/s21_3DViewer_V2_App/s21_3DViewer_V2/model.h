...
private:
  ...
  void read_number_of_dots_and_facets_from_str(char **strs_from_file,
                                               int str_number,
                                               figure_t *temp_figure);
  int number_of_lines_from_file(FILE *obj_file);
  void find_lines_number(figure_t *figure);
  void creat_hash_for_lines_number(int **temp_lines, int counter,
                                   int **hesh_arr, int hash_amount);
  void print_str_from_file(char **strs_from_file, int str_number);
  void read_dots_from_str(char **strs_from_file, int str_number,
                          figure_t *figure);
  ...
  void read_str_from_file(FILE *obj_file, char **strs_from_file,
                          int *str_number);
